...
const CLIENTS = [
  {
    ...
    flagged: false,
    new: false,
    weight: [78, 78.5, 79, 79.2, 79.8, 80],
    bench: [70, 75, 80, 82.5, 85, 87.5],
  },
  {
    name: "Priya Shah",
    goal: "Fat Loss",
    ...
    flagged: false,
    new: false,
    weight: [65, 64.5, 64, 63.8, 63.5, 63.2],
    bench: [30, 32.5, 35, 35, 37.5, 40],
  },
  {
    name: "Rohan Verma",
    goal: "Strength",
    ...
    flagged: true,
    new: false,
    weight: [85, 85, 85.5, 86, 86, 86.5],
    bench: [80, 85, 90, 90, 92.5, 95],
  },
  {
    name: "Saanvi Desai",
    goal: "Body Recomp",
    ...
    flagged: false,
    new: false,
    weight: [58, 57.8, 57.5, 57.3, 57, 56.8],
    bench: [20, 22.5, 25, 25, 27.5, 30],
  },
  {
    name: "Neha Iyer",
    goal: "Endurance",
    ...
    flagged: false,
    new: true,
    weight: [70, 70, 69.8, 69.5, 69.2, 69],
    bench: [40, 42.5, 45, 45, 47.5, 50],
  },
  {
    name: "Aman Thakur",
    goal: "Muscle Gain",
    ...
    flagged: false,
    new: false,
    weight: [72, 72.5, 73, 73.5, 74, 74.5],
    bench: [60, 65, 67.5, 70, 72.5, 75],
  },
];
  ...
  return (
    <div style={{ paddingBottom: 100 }}>
      <TopBar
        ...
        trailing={
          <>
            <IconBtn name="search" t={t} />
            <IconBtn name="bell" t={t} />
          </>
        }
      />
      ...
      <div style={{ padding: "0 16px 16px" }}>
        ...
        >
          {fc.restDay ? (
            ...
            <RingProgress
              value={fc.status === "done" ? 100 : fc.status === "live" ? 65 : 0}
              size={100}
              stroke={10}
              t={t}
            >
              {fc.status === "done" ? (
                <>
                  <Icon name="check" size={28} color={t.good} />
                  <span
                    style={{
                      fontFamily: FONT.ui,
                      fontSize: 9,
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              {fc.restDay ? "Rest day" : "Focused client"}
            </div>
            <div
              style={{
      ...
      <div style={{ padding: "0 16px" }}>
        <SectionLabel t={t} action="See all">
          Schedule
        </SectionLabel>
        <Card t={t} padding={0}>
          {SESSIONS.map((s, i) => {
            ...
            return (
              <div
                ...
                style={{
                  borderBottom:
                    i === SESSIONS.length - 1 ? "none" : `0.5px solid ${t.sep}`,
                }}
              >
                <div
                  ...
                  style={{
                    ...
                    padding: "13px 14px",
                    cursor: "pointer",
                    background: isFocused ? t.gradientSoft : "transparent",
                    position: "relative",
                  }}
                >
                  {isFocused && (
                      ...
                      {s.collision && (
                        <span
                          style={{
                            ...
                            fontWeight: 700,
                            color: t.warn,
                            background: "rgba(224,134,0,0.12)",
                            padding: "1px 5px",
                            borderRadius: 4,
                            textTransform: "uppercase",
                          }}
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            ...
            <span style={{ fontFamily: FONT.ui, fontSize: 11, color: t.ink3 }}>
              adherence
            </span>
        ...
        {["overview", "workout", "diet"].map((tab) => (
          <button
            ...
            style={{
              ...
              fontFamily: FONT.ui,
              fontSize: 13,
              fontWeight: dtab === tab ? 700 : 500,
              color: dtab === tab ? t.accent : t.ink3,
        ...
        {dtab === "overview" && (
          <>
            ...
            <Card t={t} padding={14}>
              ...
              >
                <Numeric
                  value={`${client.weight[client.weight.length - 1]}`}
                  unit="kg"
                  t={t}
                  size={22}
                />
            ...
            <Card t={t} padding={14}>
              ...
              >
                <Numeric
                  value={`${client.bench[client.bench.length - 1]}`}
                  unit="kg"
                  t={t}
                  size={22}
                />
                ...
                >
                  ↑{" "}
                  {(
                    client.bench[client.bench.length - 1] - client.bench[0]
                  ).toFixed(1)}{" "}
                  kg
                </span>
              </div>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: "12px 14px",
                    borderBottom:
                      i === arr.length - 1 ? "none" : `0.5px solid ${t.sep}`,
                  }}
                >
                  <span
                    style={{
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      gap: 8,
                      padding: "8px 0",
                      borderBottom: i < 4 ? `0.5px solid ${t.sep}` : "none",
                    }}
                  >
                    <span
                      style={{
...
function TrainerClients({ t }) {
  ...
  if (selected)
    return (
      <ClientDetail client={selected} t={t} onBack={() => setSelected(null)} />
    );
  ...
  return (
    <div style={{ paddingBottom: 100 }}>
      <TopBar
        ...
        title="Clients"
        trailing={<IconBtn name="plus" t={t} />}
      />
          ...
          {filtered.map((c, i) => (
            <div
              ...
              style={{
                ...
                padding: "13px 14px",
                borderBottom:
                  i < filtered.length - 1 ? `0.5px solid ${t.sep}` : "none",
                cursor: "pointer",
              }}
            >
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <div
                  style={{ fontFamily: FONT.ui, fontSize: 10, color: t.ink3 }}
                >
                  adherence
                </div>
              </div>
...
function TrainerPlan({ t }) {
  ...
  return (
    <div style={{ paddingBottom: 100 }}>
      <TopBar
        t={t}
        subtitle="Push/Pull/Legs — Week 4"
        title="Plan builder"
        leading={<IconBtn name="chevronL" t={t} />}
        trailing={<IconBtn name="ellipsis" t={t} />}
      />
      {/* Week strip */}
      <div style={{ padding: "0 16px 16px" }}>
        <Card t={t} padding={12}>
      ...
      <div style={{ padding: "0 16px" }}>
        {curEx ? (
          <>
              ...
              {curEx.map((e, i) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "13px 14px",
                    borderBottom:
                      i < curEx.length - 1 ? `0.5px solid ${t.sep}` : "none",
                  }}
                >
                  <div
                    style={{
            ...
            <div style={{ marginTop: 12 }}>
              <Card
                ...
                style={{
                  background: t.gradientSoft,
                  border: `0.5px solid ${t.accentRing}`,
                }}
              >
                <div
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      Add Chest Fly for upper pec isolation — complements Bench
                      press well on this push day.
                    </div>
                    <button
                      style={{
                        marginTop: 8,
          ...
          <Card t={t} padding={24} style={{ textAlign: "center" }}>
            ...
            >
              Active recovery — mobility recommended
            </div>
          </Card>
        )}
      </div>
    ...
    <div style={{ paddingBottom: 100, background: t.bg }}>
      ...
      <div style={{ padding: "0 16px 14px" }}>
        <Card
          ...
          padding={18}
          style={{
            background: resting ? t.gradient : t.bgElevated,
            border: "none",
            display: "flex",
            alignItems: "center",
            gap: 16,
            color: resting ? "#fff" : t.ink,
          }}
        >
          <div
            style={{
          ...
          >
            <svg width={80} height={80} style={{ transform: "rotate(-90deg)" }}>
              <circle
                ...
                cy={40}
                r={34}
                stroke={resting ? "rgba(255,255,255,0.25)" : t.fillTint}
                strokeWidth={6}
                fill="none"
              />
              <circle
                ...
                cy={40}
                r={34}
                stroke={resting ? "#fff" : t.accent}
                strokeWidth={6}
                fill="none"
                strokeLinecap="round"
                strokeDasharray={213.6}
                strokeDashoffset={213.6 * (1 - restTime / 60)}
            ...
            >
              ...
              >
                0:{String(restTime).padStart(2, "0")}
              </span>
            </div>
          </div>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
              <button
                ...
                style={{
                  background: resting ? "#fff" : t.gradient,
                  color: resting ? t.accent : "#fff",
                  border: 0,
                  borderRadius: 999,
                  padding: "6px 12px",
                  fontFamily: FONT.ui,
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        <Card t={t} padding={12}>
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "28px 1fr 1fr 55px 26px",
              gap: 6,
              padding: "6px 0 8px",
              borderBottom: `0.5px solid ${t.sep}`,
            }}
          ...
          {sets.map((set, i) => (
            <div
              ...
              style={{
                ...
                padding: "9px 0",
                borderBottom: `0.5px solid ${t.sep}`,
                background: i === 2 ? t.gradientSoft : "transparent",
            ...
            >
              ...
              <div
                style={{
                  ...
                  fontSize: 14,
                  fontWeight: 600,
                  color: set.done ? t.ink2 : t.ink,
                }}
              >
                {set.weight}
                <span style={{ fontSize: 10, color: t.ink3, marginLeft: 2 }}>
                  kg
                </span>
              </div>
              <div
                style={{
                  ...
                  fontSize: 14,
                  fontWeight: 600,
                  color: set.reps ? (set.done ? t.ink2 : t.ink) : t.ink4,
                }}
              >
                {set.reps || "–"}
              </div>
                ...
                {set.done ? (
                  ...
                  <div
                    style={{
                      ...
                      height: 22,
                      borderRadius: "50%",
                      border: `1.5px solid ${i === 2 ? t.accent : t.ink4}`,
                      background: i === 2 ? t.accentTint : "transparent",
                    }}
                  />
                )}
              </div>
  ...
  const settings = [
    {
      ...
      sub: "30 min before each session",
      toggle: true,
      on: true,
    },
    {
      label: "Client progress alerts",
      sub: "Notify on missed sessions",
      toggle: true,
      on: true,
    },
    {
      label: "Payment notifications",
      sub: "When client fee is logged",
      toggle: true,
      on: false,
    },
    ...
    <div style={{ paddingBottom: 100 }}>
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        <Card t={t} padding={0}>
          {topClients.map((c, i, arr) => (
            <div
              ...
              style={{
                ...
                padding: "12px 14px",
                borderBottom:
                  i < arr.length - 1 ? `0.5px solid ${t.sep}` : "none",
              }}
            >
          ...
          <div
            style={{ padding: "10px 14px", borderTop: `0.5px solid ${t.sep}` }}
          >
            <span
              style={{
                fontFamily: FONT.ui,
  ...
  return (
    <div style={{ height: "100%", position: "relative", background: t.bg }}>
      <div style={{ height: "100%", overflowY: "auto", overflowX: "hidden" }}>
        {tab === "home" && (
          <TrainerHome t={t} onSession={() => setInSession(true)} />
        )}
